...
-- Q1. What is the total revrnue generated by male vs. female customer
...
select item_purchased, round(AVG(review_rating ),2)as "Avarage Porduct Rating"
from customer
...
-- Q8. What are the 3 most purchased products witnin each category
with item_counts as (
select category,
item_purchased,
